...
*}
<div id="container" class="brinkscheckout ps15">
	<section id="brinkscheckout_header">
			...
			<div class="formcontainer">
				<div class="form">
					...
					<form action="http://www.brinkscheckout.com/prestashop/" accept-charset="utf-8" method="get">
						<ul>
							<li><input type="text" name="fullname" id="fullname" placeholder="{l s='Name(required)' mod='brinkscheckout'}" value=""></li>
							<li><input type="text" name="email" id="email" placeholder="{l s='Email(required)' mod='brinkscheckout'}" value=""></li>
							<li><input type="text" name="phone_number" id="phone_number" placeholder="{l s='Phone Number(required)' mod='brinkscheckout'}" value=""></li>
							<li><input type="text" name="website_url" id="website_url" placeholder="{l s='Website(required)' mod='brinkscheckout'}" value=""></li>
	...
	<div class="sticker">
		<img src="{$twocheckout_img_url|escape:false}img/info.png"/>{l s='To start accepting payments, you will need to provide the information below. To get them, you need to sign up first:' mod='brinkscheckout'}
		<div id="button">
