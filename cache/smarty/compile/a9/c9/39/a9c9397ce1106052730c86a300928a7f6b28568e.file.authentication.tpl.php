<?php /* Smarty version Smarty-3.1.19, created on 2016-04-18 20:33:11
         compiled from "/var/www/html/themes/theme1133/authentication.tpl" */ ?>
<?php /*%%SmartyHeaderCode:112360353157157cc7d42562-17034853%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a9c9397ce1106052730c86a300928a7f6b28568e' => 
    array (
      0 => '/var/www/html/themes/theme1133/authentication.tpl',
      1 => 1460904921,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '112360353157157cc7d42562-17034853',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57157cc854d2c3_44671576',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57157cc854d2c3_44671576')) {function content_57157cc854d2c3_44671576($_smarty_tpl) {?><?php $_smarty_tpl->_capture_stack[0][] = array('path', null, null); ob_start(); ?>
...
<?php } elseif (($_smarty_tpl->tpl_vars['hide_left_column']->value&&$_smarty_tpl->tpl_vars['hide_right_column']->value)&&($_smarty_tpl->tpl_vars['hide_left_column']->value=='true'&&$_smarty_tpl->tpl_vars['hide_right_column']->value=='true')) {?>
	<?php $_smarty_tpl->tpl_vars["linkWidth"] = new Smarty_variable("2", null, 0);?>
<?php } else { ?>
	<?php $_smarty_tpl->tpl_vars["linkWidth"] = new Smarty_variable("1", null, 0);?>
<?php }?>

<?php if (!isset($_smarty_tpl->tpl_vars['email_create']->value)) {?>
	<div class="row">
		<div class="col-xs-12 col-sm-<?php echo 12/$_smarty_tpl->tpl_vars['linkWidth']->value;?>
">
...
" rel="nofollow"><?php echo smartyTranslate(array('s'=>'Forgot your password?'),$_smarty_tpl);?>
					...
					<p class="submit">
						<?php if (isset($_smarty_tpl->tpl_vars['back']->value)) {?>
                        	<input type="hidden" class="hidden" name="back" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['back']->value, ENT_QUOTES, 'UTF-8', true);?>
" />
                        <?php }?>
