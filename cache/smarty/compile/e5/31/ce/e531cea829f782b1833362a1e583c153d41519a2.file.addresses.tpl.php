<?php /* Smarty version Smarty-3.1.19, created on 2016-04-18 20:35:03
         compiled from "/var/www/html/themes/theme1133/addresses.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2787712257157d3764c235-88988009%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e531cea829f782b1833362a1e583c153d41519a2' => 
    array (
      0 => '/var/www/html/themes/theme1133/addresses.tpl',
      1 => 1460904921,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2787712257157d3764c235-88988009',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57157d377f0013_14525573',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57157d377f0013_14525573')) {function content_57157d377f0013_14525573($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/var/www/html/tools/smarty/plugins/modifier.replace.php';
...
"><?php echo smartyTranslate(array('s'=>'My account'),$_smarty_tpl);?>
    ...
    <span class="navigation_page"><?php echo smartyTranslate(array('s'=>'My addresses'),$_smarty_tpl);?>
</span>
...
?>
                <div class="col-xs-12 col-sm-6 address">
                    <ul class="<?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['myLoop']['last']) {?>last_item<?php } elseif ($_smarty_tpl->getVariable('smarty')->value['foreach']['myLoop']['first']) {?>first_item<?php }?><?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['myLoop']['index']%2) {?> alternate_item<?php } else { ?> item<?php }?> box">
                        <li>
                            <h3 class="page-subheading"><?php echo $_smarty_tpl->tpl_vars['address']->value['object']['alias'];?>
</h3>
                        </li>
...
"<?php }?>>
                        ...
                        <li class="address_update">
                            <a class="btn btn-success btn-sm" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['address']->value['object']['id']);?>
...
">
                            ...
                            <a class="btn btn-danger btn-sm" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['address']->value['object']['id']);?>
...
" title="<?php echo smartyTranslate(array('s'=>'Back to your account'),$_smarty_tpl);?>
">
        	<span>
