<div class="alert alert-info">
    <img src="../modules/cheque/cheque.jpg" style="float:left; margin-right:15px;" width="86" height="49" alt="">
    <p>
    	<strong>{l s="This module allows you to accept payments by check." mod='cheque'}</strong>
    </p>
