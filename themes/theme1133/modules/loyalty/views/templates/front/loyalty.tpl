...
<ul class="footer_links clearfix">
	<li>
		<a class="btn btn-default btn-sm" href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}" title="{l s='Back to Your Account' mod='loyalty'}" rel="nofollow">
        	<span>
	...
	<li>
		<a class="btn btn-default btn-sm" href="{$base_dir}" title="{l s='Home' mod='loyalty'}">
        	<span>
            	<i class="fa fa-chevron-left"></i>
