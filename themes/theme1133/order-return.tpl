	...
	{if $orderRet->state == 2}
        <div class="box">
            ...
            <ul>
                ...
                <li>{l s='Please print out the'} 
                    <a href="{$link->getPageLink('pdf-order-return', true, NULL, "id_order_return={$orderRet->id|intval}")|escape:'html':'UTF-8'}" title="{l s='PDF return slip'}">
                        {l s='PDF return slip'}
                    </a> 
                    {l s='and include it with your package.'}
                </li>
                <li>{l s='Please see the PDF return slip'} (
                    <a href="{$link->getPageLink('pdf-order-return', true, NULL, "id_order_return={$orderRet->id|intval}")|escape:'html':'UTF-8'}">{l s='for the correct address.'}</a>
                    )
                </li>
            </ul>
